...
public class UIPenjualan extends javax.swing.JFrame {
    ...
    private void fillComboBarang(){
        ModelBarang barang1 = new ModelBarang("Pilih Menu", "NULL", 0);
        ModelBarang barang2 = new ModelBarang("Spagheti", "paket", 30000);
        ModelBarang barang3 = new ModelBarang("Pizza", "paket", 65000);
        ModelBarang barang4 = new ModelBarang("Steak", "pcs", 40000);
